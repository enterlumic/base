            ...
            "columnDefs": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row, meta) {
                      ...
                      <a href="#modal_form_modal_comandos" id="' + row[0] + '" data-bs-toggle="modal" class="text-success p-1 update-comandos"><i class="bx bxs-edit-alt"></i></a>\
                            <a href="javascript:void(0)" id="' + row[0] + '" class="text-danger p-1 delete-comandos"><i class="bx bxs-trash"></i></a></div>' +  row[1];
                    }
                },
                {
                    "visible": false,
