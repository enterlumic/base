...
worksheet2 = workbook.add_worksheet('Asistencias')

worksheet2.set_column('A:A', 9)
worksheet2.set_column('B:B', 50)
worksheet2.set_column('C:C', 14)
worksheet2.set_column('D:D', 13)
worksheet2.set_column('E:E', 13)
worksheet2.set_column('F:F', 13)

border_cell = workbook.add_format({'border': 1})

worksheet2.write('A1', "ID", merge_format)
worksheet2.write('B1', "NOMBRE", merge_format)
worksheet2.write('C1', "USERGROUP", merge_format)
worksheet2.write('D1', jsonObject['dia'], merge_format)
worksheet2.write('E1', "FALTAS", merge_format)
worksheet2.write('F1', "ASISTENCIAS", merge_format)

row= 1
for item in jsonObject["asistencias"]:
    row+=1
    worksheet2.write('A'+ str(row), item['id'], border_center)
    worksheet2.write('B'+ str(row), item['nombre'], border_cell)
    worksheet2.write('C'+ str(row), item['user_group'], border_cell)
    worksheet2.write('D'+ str(row), item['asistencia_abr'], border_center)
    worksheet2.write('E'+ str(row), item['faltas'], border_center)
    worksheet2.write('F'+ str(row), item['asistencias'], border_center)
