        ...
        @include('modal_default.modal')

        <!-- JAVASCRIPT -->
        <script src="assets/libs/bootstrap/js/bootstrap.bundle.min.js?{{ rand() }}"></script>
        <script src="assets/libs/metismenu/metisMenu.min.js?{{ rand() }}"></script>
        <script src="assets/libs/simplebar/simplebar.min.js?{{ rand() }}"></script>
        <script src="assets/libs/node-waves/waves.min.js?{{ rand() }}"></script>
        <script src="assets/libs/feather-icons/feather.min.js?{{ rand() }}"></script>
        <!-- pace js -->
        <script src="assets/libs/pace-js/pace.min.js?{{ rand() }}"></script>
        ...
        <script src="assets/js/core_js/comandos.js?{{ rand() }}"></script>
